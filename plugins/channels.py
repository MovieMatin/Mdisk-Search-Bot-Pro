...
@Client.on_message(
    filters.command("allow") & filters.private & filters.chat(Config.BOT_OWNER)
)
...
@Client.on_message(
    filters.command("disallow") & filters.private & filters.chat(Config.BOT_OWNER)
)
...
@Client.on_message(
    filters.command("channels") & filters.private & filters.chat(Config.BOT_OWNER)
)
